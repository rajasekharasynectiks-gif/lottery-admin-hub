      ...
      <div className="flex min-h-screen w-full bg-background text-foreground">
        ...
        >
          <div className="flex h-14 items-center gap-2 border-b border-sidebar-border px-4">
            <div className="grid h-8 w-8 place-items-center rounded-md bg-brand text-brand-foreground font-bold">G</div>
                      ...
                      return (
                        <li key={item.to}>
                          ...
                          >
                            ...
                            {item.badge && (
                              <span className="ml-auto rounded bg-brand/90 px-1.5 py-px text-[10px] font-semibold text-brand-foreground tabular">
                                {item.badge}
                              </span>
                            )}
                          </Link>
        ...
        <div className="flex min-w-0 flex-1 flex-col lg:pl-0">
          ...
          <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-border bg-surface/95 px-4 backdrop-blur">
            ...
            <Button variant="ghost" size="icon" className="text-muted-foreground" onClick={() => setDark((d) => !d)} aria-label="Toggle theme">
